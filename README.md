...
4. **Seller onboarding** — guided store creation, branding, catalog setup and progressive completion. Store registration, tenant-domain provisioning, seller authentication, store settings and catalog onboarding test coverage are now implemented.
