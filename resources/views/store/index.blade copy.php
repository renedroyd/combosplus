...
<body class="bg-gray-50">
    ...
    <!-- BARRA DE NAVEGACIÓN (STICKY) con efecto transparente al hacer scroll -->
    <nav id="navbar" class="sticky top-0 z-50 bg-white shadow-md py-3 px-4 md:px-8 flex items-center justify-between transition-all duration-300">
        ...
        <div class="hidden md:flex space-x-8 text-gray-600 font-medium">
            ...
            <a href="#" class="hover:text-green-600 transition">Productos</a>
            <a href="#" class="hover:text-green-600 transition">Ofertas</a>
            <a href="#" class="hover:text-green-600 transition">Recetas</a>
            <a href="#" class="hover:text-green-600 transition">Contacto</a>
        </div>

        <!-- Iconos de usuario y carrito -->
        <div class="flex items-center space-x-4">
            <i class="fas fa-search text-gray-500 hover:text-green-600 cursor-pointer transition"></i>
            <i class="fas fa-user text-gray-500 hover:text-green-600 cursor-pointer transition"></i>
            <div class="relative">
                <i class="fas fa-shopping-cart text-gray-500 hover:text-green-600 cursor-pointer transition"></i>
                <span class="absolute -top-2 -right-3 bg-red-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">3</span>
            </div>
            ...
            <aside class="lg:w-80 order-1">
                <div class="bg-white rounded-xl shadow-md p-6 sticky top-20">
                            ...
                            <li>
                                <label class="flex items-center justify-between text-gray-600">
                                    <span class="flex items-center">
                                        <input type="checkbox" name="categorias[]" value="{{ $category->id }}" class="rounded text-green-600 focus:ring-green-500 mr-2">
                                        {{ $category->name }}
                                    </span>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex items-center space-x-2">
                            <input type="number" placeholder="Min" class="w-1/2 border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500">
                            <span>-</span>
                            <input type="number" placeholder="Max" class="w-1/2 border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500">
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <span class="bg-gray-200 text-gray-700 px-3 py-1 rounded-full text-sm cursor-pointer hover:bg-green-600 hover:text-white transition">{{ $tag }}</span>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <select class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-green-500">
                    ...
                    <button class="mt-6 w-full bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-lg transition">
                        Aplicar filtros
                    </button>
                </div>
            </aside>
            ...
            <section class="flex-1 order-2">
                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
                    ...
                    <div class="mt-2 sm:mt-0">
                        ...
                        <select id="ordenar" class="block w-full sm:w-auto px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500 bg-white">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition duration-300 flex flex-col h-full">
                        ...
                        <div class="p-4 flex-1 flex flex-col">
                            ...
                            <button class="mt-4 w-full bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded-lg text-sm font-medium transition flex items-center justify-center">
                ...
                <!-- Paginación (si los productos están paginados) -->
                @if(method_exists($products, 'links'))
                <div class="mt-8">
                    {{ $products->links() }}
                </div>
                @else
                <!-- Si no hay paginación, podrías mantener el ejemplo estático o eliminarlo -->
                <div class="mt-8 flex justify-center">
                    <nav class="inline-flex rounded-md shadow">
                        <a href="#" class="px-4 py-2 bg-white border border-gray-300 text-gray-500 hover:bg-gray-50 rounded-l-md">Anterior</a>
                        <a href="#" class="px-4 py-2 bg-green-600 border border-green-600 text-white">1</a>
                        ...
                        <a href="#" class="px-4 py-2 bg-white border border-gray-300 text-gray-500 hover:bg-gray-50 rounded-r-md">Siguiente</a>
                    </nav>
                </div>
                @endif
            </section>
    ...
    <!-- FOOTER MEJORADO CON ENLACES COMUNES -->
