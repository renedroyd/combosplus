...
<nav class="hidden items-center gap-7 text-sm font-medium sm:flex"><a href="{{ route('marketplace.stores') }}" class="text-slate-600 hover:text-blue-600">Tiendas</a><a href="{{ route('marketplace.register') }}" class="rounded-xl bg-blue-600 px-4 py-2.5 text-white hover:bg-blue-500">Registra tu tienda</a></nav>
