...
<section class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
    ...
    <form method="GET" class="mt-8 grid gap-3 rounded-2xl border border-slate-200 bg-slate-50 p-4 sm:grid-cols-[1fr_auto_auto_auto]">
        ...
        <select id="product-category" name="category" class="min-h-11 rounded-xl border border-slate-300 bg-white px-4">
    ...
    @if($query !== '' || $category !== '')
        <div class="mt-5 flex flex-wrap items-center gap-2 text-sm text-slate-500">
            ...
            <a href="{{ route('marketplace.products') }}" class="font-semibold text-slate-700 hover:text-blue-600">Limpiar</a>
        </div>
    @endif
